...
tgtFilePath = r'C:\Users\Stanley Lo\Documents\Summer 2021 NSERC\subway_maps_repo\Targets\target_SNAr_BLANK.csv'
...
def add_rxn_json(sum_suzuki_FilePath, sum_BHA_FilePath, sum_deboc_FilePath, sum_SNAr_FilePath, jsonFilePath, tgtFilePath):
    data = []
    with open(jsonFilePath, encoding='utf-8') as csvf:
        csvReader = json.load(csvf)
        # Convert each row into a dictionary
    ...
    with open(tgtFilePath, encoding='utf-8') as csvf:
        ...
        for rows in csvReader:
            ...
            rxn_SMILES = rows["a"] + "." + rows["b"] + ">>" + rows["ab"]
            temp_data["rxn_SMILES"] = rxn_SMILES
            temp_data["type"] = "SNAr"
            temp_data["rxn_type"] = "wingSuzuki"
            id_count += 1
    ...
    with open(tgtFilePath, encoding='utf-8') as csvf2:
        ...
        for rows in csvReader2:
            ...
            temp_data["scale"] = scale
            temp_data["n_parr"] = n_parr
            rxn_SMILES = rows["ab"] + "." + rows["c"] + ">>" + rows["F"]
            temp_data["rxn_SMILES"] = rxn_SMILES
            temp_data["type"] = "SNAr"
    ...
    with open(tgtFilePath, encoding='utf-8') as csvf5:
        ...
        for rows in csvReader5:
            ...
            temp_data["scale"] = scale
            temp_data["n_parr"] = n_parr
            rxn_SMILES = rows["F"] + "." + rows["carbazole"] + ">>" + rows["pentamer"]
            temp_data["rxn_SMILES"] = rxn_SMILES
            temp_data["type"] = "SNAr"
    ...
    with open(tgtFilePath, encoding='utf-8') as csvf3:
        ...
        for rows in csvReader3:
            ...
            temp_data["scale"] = scale
            temp_data["n_parr"] = n_parr
            rxn_SMILES = rows["N-Boc"] + ">>" + rows["N-H"]
            temp_data["rxn_SMILES"] = rxn_SMILES
            temp_data["type"] = "SB"
    ...
    with open(tgtFilePath, encoding='utf-8') as csvf4:
        ...
        for rows in csvReader4:
            ...
            temp_data["scale"] = scale
            temp_data["n_parr"] = n_parr
            rxn_SMILES = rows["N-H"] + "." + rows["halide"] + ">>" + rows["pentamer"]
            temp_data["rxn_SMILES"] = rxn_SMILES
            temp_data["type"] = "SB"
...
add_rxn_json(sum_suzuki_FilePath, sum_BHA_FilePath, sum_deboc_FilePath, sum_SNAr_FilePath, jsonFilePath, tgtFilePath)