...
import json
from subway.data.index_adj_list import *  # put file outside of subway package, and you'll be able to import relative path!
...
plt.savefig("directed_graph_case7.png")
